...
public class FactoryLogicLangSyntacticSequencer extends AbstractSyntacticSequencer {

	protected FactoryLogicLangGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (FactoryLogicLangGrammarAccess) access;
	}

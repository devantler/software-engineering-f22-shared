...
class MqttGenerator {
	...
	protected def static void generateMqttService(IFileSystemAccess2 fsa) {
		fsa.generateFile('OrchestratorService/Mqtt/MqttService.cs', 
			'''
			using System;
	...
	protected def static void generateIMqttService(IFileSystemAccess2 fsa) {
		fsa.generateFile('OrchestratorService/Mqtt/IMqttService.cs', 
			'''
			using System.Threading.Tasks;
	...
	protected def static void generateMqttTopics(IFileSystemAccess2 fsa) {
		fsa.generateFile('OrchestratorService/Mqtt/MqttTopics.cs', 
			'''
			namespace Mqtt
			{
